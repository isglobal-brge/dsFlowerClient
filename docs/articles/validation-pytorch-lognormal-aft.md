...
| 2\. Train centralized baseline | status = ok \| metric = lognormal_aft_nll |
| 3\. Evaluate centralized baseline | loss = 3.4966 \| accuracy = NA |
...
| 2\. Prepare server-side dsFlower nodes | template = pytorch_lognormal_aft \| privacy = sandbox_open |
| 3\. Start Flower SuperLink/SuperNodes | federated_run_id = 16715368873237040463 |
| 4\. Run federated training | rounds = 1 \| federated_loss = 3.6834 \| client_failures = 0.0000 |
...
#> [dsFlower] model: pytorch_lognormal_aft | strategy: fedavg | rounds: 1
#> [dsFlower] run id: 16715368873237040463
#> [Flower] aggregate_fit/evaluate: clients=3 failures=0.0000
#> [Flower] final federated loss: 3.6834
#> [cleanup] status: ok
```
...
|---:|---:|---:|---:|:---|:---|
| 3.4966 | 3.6834 | 8.9915 | 0 | TRUE | pass |
