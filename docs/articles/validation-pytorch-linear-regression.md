...
This run trained the pytorch_linear_regression template on the
regression task (target y, 12 synthetic features) for 1 federated
...
The centralized baseline reached a mse of 3.2118; the federated run
reached 3.2980 with 0 client failures, leaving this template **pass**.
...
pytorch_linear_regression.](validation-pytorch-linear-regression_files/figure-html/unnamed-chunk-2-1.png)
