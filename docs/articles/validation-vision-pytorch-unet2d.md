...
This run trained the pytorch_unet2d template on the segmentation task
(target mask_path) for 1 federated round(s) under the sandbox_open
profile, across 3 Opal/Rock nodes that staged 12 synthetic 64x64 PNG
samples.

The centralized baseline reached a dice_bce_loss of 1.3099; the
federated run reached 1.4397 (delta 0.1298) with 0 client failures,
...
| centralized_loss | centralized_dice | federated_loss | delta_loss | federated_n_failures | validation_status |
|---:|---:|---:|---:|---:|:---|
| 1.3099 | 0 | 1.4397 | 0.1298 | 0 | pass |
...
pytorch_unet2d.](validation-vision-pytorch-unet2d_files/figure-html/unnamed-chunk-2-1.png)
