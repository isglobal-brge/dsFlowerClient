...
This run trained the pytorch_mlp template on the classification task
...
The centralized baseline reached a binary_cross_entropy of 0.7006; the
federated run reached 0.6730 with 0 client failures, leaving this
...
pytorch_mlp.](validation-pytorch-mlp_files/figure-html/unnamed-chunk-2-1.png)
