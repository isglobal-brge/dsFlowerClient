...
#> 1 opal1 https://localhost:8443 dsflower_demo vignette_medmnist_20260513003151
#> 2 opal2 https://localhost:8444 dsflower_demo vignette_medmnist_20260513003151
#> 3 opal3 https://localhost:8445 dsflower_demo vignette_medmnist_20260513003151
```
...
#> [centralized] rows: 383 train / 127 test
...
#> [upload] https://localhost:8443 -> dsflower_demo.vignette_medmnist_20260513003151_site1
#> Warning in opalr::opal.table_save(opal, site_tables[[i]], project =
#> opal_project, : Coercing data.frame to a tibble...
#> [upload] https://localhost:8444 -> dsflower_demo.vignette_medmnist_20260513003151_site2
#> Warning in opalr::opal.table_save(opal, site_tables[[i]], project =
#> opal_project, : Coercing data.frame to a tibble...
#> [upload] https://localhost:8445 -> dsflower_demo.vignette_medmnist_20260513003151_site3
#> 
#> Logging into the collaborating servers
#> [DataSHIELD] connected nodes: 3
#> SuperLink started (PID: 71270)
...
#> Flower App configuration warnings in '/private/var/folders/tn/qg45ss_91k375mrb66zqhx_m0000gn/T/RtmpaV499z/dsflower_app/sklearn_logreg/pyproject.toml':
#> - Recommended property "description" missing in [project]
#> - Recommended property "license" missing in [project]
#> 🎊 Successfully started run 12344355685247350850
#> INFO :      Start `flwr-serverapp` process
#> 🎊 Successfully installed sklearn_logreg to /var/folders/tn/qg45ss_91k375mrb66zqhx_m0000gn/T/RtmpaV499z/dsflower_superlink/apps/dsflower.sklearn_logreg.0.1.0.13de87f6.
...
#> INFO :      
#> INFO :      [SUMMARY]
#> INFO :      Run finished 2 round(s) in 38.60s
#> INFO :       History (loss, distributed):
#> INFO :           round 1: 0.5105618864422369
#> INFO :           round 2: 0.5105599607142649
#> INFO :      
#> INFO :
#> Model saved to ./dsflower_output/sklearn_logreg_FedAvg_2r_20260513_003319
#> SuperLink stopped.
...
#> [dsFlower] output_dir: ./dsflower_output/sklearn_logreg_FedAvg_2r_20260513_003319
print(history)
...
|:---------|:---------|------------:|---------:|--------:|
| auc      | auc      |      0.7654 |   0.7985 |  0.0331 |
| accuracy | accuracy |      0.6929 |   0.7165 |  0.0236 |
| log_loss | log_loss |      0.6140 |   0.5500 | -0.0641 |
| brier    | brier    |      0.1990 |   0.1765 | -0.0226 |
