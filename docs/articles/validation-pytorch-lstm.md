...
This run trained the pytorch_lstm template on the classification task
...
The centralized baseline reached a binary_cross_entropy of 0.6957; the
federated run reached 0.6962 with 0 client failures, leaving this
...
pytorch_lstm.](validation-pytorch-lstm_files/figure-html/unnamed-chunk-2-1.png)
