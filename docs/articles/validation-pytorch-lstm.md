...
| centralized_loss           | 0.6957               |
| centralized_accuracy       | 0.5000               |
| federated_status           | ok                   |
| federated_loss             | 0.6962               |
...
pytorch_lstm.](validation-pytorch-lstm_files/figure-html/unnamed-chunk-3-1.png)
...
| 3\. Evaluate centralized baseline | loss = 0.6957 \| accuracy = 0.5000 |
...
| 2\. Prepare server-side dsFlower nodes | template = pytorch_lstm \| privacy = sandbox_open |
| 3\. Start Flower SuperLink/SuperNodes | federated_run_id = 11195137466471468973 |
| 4\. Run federated training | rounds = 1 \| federated_loss = 0.6962 \| client_failures = 0.0000 |
...
#> [dsFlower] model: pytorch_lstm | strategy: fedavg | rounds: 1
#> [dsFlower] run id: 11195137466471468973
#> [Flower] aggregate_fit/evaluate: clients=3 failures=0.0000
#> [Flower] final federated loss: 0.6962
#> [cleanup] status: ok
```
