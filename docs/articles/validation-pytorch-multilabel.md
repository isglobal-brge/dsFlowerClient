...
| Field                      | Value                   |
|:---------------------------|:------------------------|
| method                     | pytorch_multilabel      |
| task                       | classification          |
| target                     | label_a,label_b,label_c |
| n_features                 | 12                      |
| rounds                     | 1                       |
| centralized_metric         | multilabel_bce          |
...
pytorch_multilabel.](validation-pytorch-multilabel_files/figure-html/unnamed-chunk-3-1.png)
...
| 2\. Train centralized baseline    | status = ok \| metric = multilabel_bce |
| 3\. Evaluate centralized baseline | loss = 0.5933 \| accuracy = 0.7704     |
...
#> [centralized] method: pytorch_multilabel
#> [centralized] task: classification | target: label_a,label_b,label_c | features: x1..x12
#> [centralized] status: ok
#> [centralized] multilabel_bce: 0.5933
#> [centralized] accuracy: 0.7704
```
