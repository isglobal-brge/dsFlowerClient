...
| centralized_loss           | 0.4348         |
| centralized_accuracy       | 0.8963         |
| federated_status           | ok             |
| federated_loss             | 0.6931         |
| federated_n_failures       | NA             |
| delta_loss                 | 0.2583         |
...
| 3\. Start Flower SuperLink/SuperNodes | federated_run_id = 5976342020337348991 |
| 4\. Run federated training | rounds = 1 \| federated_loss = 0.6931 \| client_failures = NA |
...
#> [dsFlower] run id: 5976342020337348991
#> [Flower] aggregate_fit/evaluate: clients=3 failures=NA
...
|---:|---:|---:|---:|:---|:---|
| 0.4348 | 0.6931 | 1.3371 | NA | TRUE | pass |
