...
pytorch_resnet18.](validation-vision-pytorch-resnet18_files/figure-html/unnamed-chunk-3-1.png)

To reproduce only this method against configured Opal servers:

``` sh
DSFLOWER_VALIDATE_VISION_METHODS=pytorch_resnet18 Rscript inst/demos/validate_vision_methods.R
```
