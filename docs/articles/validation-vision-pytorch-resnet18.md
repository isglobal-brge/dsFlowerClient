# Vision Validation: pytorch_resnet18
...
This run trained the pytorch_resnet18 template on the classification
...
The centralized baseline reached a cross_entropy of 0.5605; the
federated run reached 0.5399 (delta -0.0206) with 0 client failures,
...
|---:|---:|---:|---:|---:|:---|
| 0.5605 | 0.5 | 0.5399 | -0.0206 | 0 | pass |
...
pytorch_resnet18.](validation-vision-pytorch-resnet18_files/figure-html/unnamed-chunk-2-1.png)
