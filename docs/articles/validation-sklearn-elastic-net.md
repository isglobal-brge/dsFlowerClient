# Validation: sklearn_elastic_net
...
| Field                      | Value               |
|:---------------------------|:--------------------|
| method                     | sklearn_elastic_net |
| task                       | classification      |
| target                     | outcome             |
| n_features                 | 12                  |
| rounds                     | 1                   |
| centralized_metric         | log_loss            |
| centralized_loss           | 0.1965              |
| centralized_accuracy       | 0.9074              |
| federated_status           | ok                  |
| federated_loss             | 0.2000              |
...
sklearn_elastic_net.](validation-sklearn-elastic-net_files/figure-html/unnamed-chunk-3-1.png)
...
| 3\. Evaluate centralized baseline | loss = 0.1965 \| accuracy = 0.9074 |
