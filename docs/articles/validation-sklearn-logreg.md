...
This run trained the sklearn_logreg template on the classification task
...
The centralized baseline reached a log_loss of 0.2051; the federated run
reached 0.2335 with 0 client failures, leaving this template **pass**.
...
sklearn_logreg.](validation-sklearn-logreg_files/figure-html/unnamed-chunk-2-1.png)
