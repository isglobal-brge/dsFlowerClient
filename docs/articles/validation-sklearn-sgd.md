...
| centralized_loss           | 0.1955         |
| centralized_accuracy       | 0.9074         |
| federated_status           | ok             |
| federated_loss             | 0.2011         |
...
sklearn_sgd.](validation-sklearn-sgd_files/figure-html/unnamed-chunk-3-1.png)
...
| 3\. Evaluate centralized baseline | loss = 0.1955 \| accuracy = 0.9074 |
...
| 2\. Prepare server-side dsFlower nodes | template = sklearn_sgd \| privacy = sandbox_open |
| 3\. Start Flower SuperLink/SuperNodes | federated_run_id = 7268609730905247192 |
| 4\. Run federated training | rounds = 1 \| federated_loss = 0.2011 \| client_failures = 0.0000 |
...
#> [dsFlower] model: sklearn_sgd | strategy: fedavg | rounds: 1
#> [dsFlower] run id: 7268609730905247192
#> [Flower] aggregate_fit/evaluate: clients=3 failures=0.0000
#> [Flower] final federated loss: 0.2011
#> [cleanup] status: ok
```
...
|---:|---:|---:|---:|:---|:---|
| 0.1955 | 0.2011 | 0.7389 | 0 | TRUE | pass |
