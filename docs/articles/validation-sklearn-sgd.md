...
This run trained the sklearn_sgd template on the classification task
...
The centralized baseline reached a log_loss of 0.1955; the federated run
reached 0.2011 with 0 client failures, leaving this template **pass**.
...
sklearn_sgd.](validation-sklearn-sgd_files/figure-html/unnamed-chunk-2-1.png)
