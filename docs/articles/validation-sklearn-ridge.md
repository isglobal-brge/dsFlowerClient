...
This run trained the sklearn_ridge template on the classification task
...
The centralized baseline reached a ridge_decision_mse of 0.4978; the
federated run reached 0.5092 with 0 client failures, leaving this
...
sklearn_ridge.](validation-sklearn-ridge_files/figure-html/unnamed-chunk-2-1.png)
