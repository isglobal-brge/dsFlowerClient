...
| 3\. Start Flower SuperLink/SuperNodes | federated_run_id = 17350604484054120936 |
| 4\. Run federated training | rounds = 1 \| federated_loss = 2.6362 \| client_failures = 0.0000 |
...
#> [dsFlower] run id: 17350604484054120936
#> [Flower] aggregate_fit/evaluate: clients=3 failures=0.0000
#> [Flower] final federated loss: 2.6362
#> [cleanup] status: ok
```
...
|---:|---:|---:|---:|:---|:---|
| 4.8611 | 2.6362 | 12.4027 | 0 | TRUE | pass |
