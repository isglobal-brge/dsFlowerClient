...
| Field                      | Value                  |
|:---------------------------|:-----------------------|
| method                     | pytorch_coxph          |
| task                       | survival               |
| target                     | time,event             |
| n_features                 | 12                     |
| rounds                     | 1                      |
| centralized_metric         | cox_partial_likelihood |
| centralized_loss           | 4.8611                 |
| centralized_accuracy       | NA                     |
| federated_status           | ok                     |
| federated_loss             | 2.7456                 |
...
pytorch_coxph.](validation-pytorch-coxph_files/figure-html/unnamed-chunk-3-1.png)
...
| 3\. Select task target | time, event |
...
| 2\. Train centralized baseline | status = ok \| metric = cox_partial_likelihood |
| 3\. Evaluate centralized baseline | loss = 4.8611 \| accuracy = NA |
...
#> [centralized] method: pytorch_coxph
#> [centralized] task: survival | target: time,event | features: x1..x12
#> [centralized] status: ok
#> [centralized] cox_partial_likelihood: 4.8611
...
| 2\. Prepare server-side dsFlower nodes | template = pytorch_coxph \| privacy = sandbox_open |
| 3\. Start Flower SuperLink/SuperNodes | federated_run_id = 11970293262233005566 |
| 4\. Run federated training | rounds = 1 \| federated_loss = 2.7456 \| client_failures = 0.0000 |
...
#> [dsFlower] model: pytorch_coxph | strategy: fedavg | rounds: 1
#> [dsFlower] run id: 11970293262233005566
#> [Flower] aggregate_fit/evaluate: clients=3 failures=0.0000
#> [Flower] final federated loss: 2.7456
#> [cleanup] status: ok
```
...
|---:|---:|---:|---:|:---|:---|
| 4.8611 | 2.7456 | 12.4027 | 0 | TRUE | pass |
