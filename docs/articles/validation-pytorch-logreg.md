...
This run trained the pytorch_logreg template on the classification task
...
The centralized baseline reached a binary_cross_entropy of 0.6188; the
federated run reached 0.6153 with 0 client failures, leaving this
...
pytorch_logreg.](validation-pytorch-logreg_files/figure-html/unnamed-chunk-2-1.png)
