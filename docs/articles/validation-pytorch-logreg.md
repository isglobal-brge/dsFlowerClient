...
| Field                      | Value                |
|:---------------------------|:---------------------|
| method                     | pytorch_logreg       |
| task                       | classification       |
| target                     | outcome              |
| n_features                 | 12                   |
| rounds                     | 1                    |
| centralized_metric         | binary_cross_entropy |
| centralized_loss           | 0.6188               |
| centralized_accuracy       | 0.6704               |
| federated_status           | ok                   |
| federated_loss             | 0.6153               |
...
pytorch_logreg.](validation-pytorch-logreg_files/figure-html/unnamed-chunk-3-1.png)
...
| 2\. Train centralized baseline | status = ok \| metric = binary_cross_entropy |
| 3\. Evaluate centralized baseline | loss = 0.6188 \| accuracy = 0.6704 |
...
#> [centralized] method: pytorch_logreg
#> [centralized] task: classification | target: outcome | features: x1..x12
#> [centralized] status: ok
#> [centralized] binary_cross_entropy: 0.6188
#> [centralized] accuracy: 0.6704
```
...
| 2\. Prepare server-side dsFlower nodes | template = pytorch_logreg \| privacy = sandbox_open |
| 3\. Start Flower SuperLink/SuperNodes | federated_run_id = 8719284997835730093 |
| 4\. Run federated training | rounds = 1 \| federated_loss = 0.6153 \| client_failures = 0.0000 |
...
#> [dsFlower] model: pytorch_logreg | strategy: fedavg | rounds: 1
#> [dsFlower] run id: 8719284997835730093
#> [Flower] aggregate_fit/evaluate: clients=3 failures=0.0000
#> [Flower] final federated loss: 0.6153
#> [cleanup] status: ok
```
...
|---:|---:|---:|---:|:---|:---|
| 0.6188 | 0.6153 | 1.797 | 0 | TRUE | pass |
