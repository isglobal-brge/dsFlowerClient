...
| 3\. Evaluate centralized baseline | loss = 0.6658 \| accuracy = 0.6259 |
...
#> [centralized] method: pytorch_tcn
#> [centralized] task: classification | target: outcome | features: x1..x12
#> [centralized] status: ok
#> [centralized] binary_cross_entropy: 0.6658
#> [centralized] accuracy: 0.6259
```
...
| 2\. Prepare server-side dsFlower nodes | template = pytorch_tcn \| privacy = sandbox_open |
| 3\. Start Flower SuperLink/SuperNodes | federated_run_id = 12243203248819556286 |
| 4\. Run federated training | rounds = 1 \| federated_loss = 0.6795 \| client_failures = 0.0000 |
...
#> [dsFlower] model: pytorch_tcn | strategy: fedavg | rounds: 1
#> [dsFlower] run id: 12243203248819556286
#> [Flower] aggregate_fit/evaluate: clients=3 failures=0.0000
#> [Flower] final federated loss: 0.6795
#> [cleanup] status: ok
```
