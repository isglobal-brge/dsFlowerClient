...
This run trained the sklearn_svm template on the classification task
...
The centralized baseline reached a hinge_loss of 0.8285; the federated
run reached 1.0935 with 0 client failures, leaving this template
...
sklearn_svm.](validation-sklearn-svm_files/figure-html/unnamed-chunk-2-1.png)
