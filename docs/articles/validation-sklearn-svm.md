...
sklearn_svm.](validation-sklearn-svm_files/figure-html/unnamed-chunk-3-1.png)
...
| 2\. Train centralized baseline    | status = ok \| metric = hinge_loss |
| 3\. Evaluate centralized baseline | loss = 0.8285 \| accuracy = 0.9037 |
...
#> [centralized] method: sklearn_svm
#> [centralized] task: classification | target: outcome | features: x1..x12
#> [centralized] status: ok
#> [centralized] hinge_loss: 0.8285
#> [centralized] accuracy: 0.9037
```
