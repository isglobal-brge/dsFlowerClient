...
BreastMNIST images, average-pools each image into a compact `7 x 7` feature
table, trains a centralized baseline, then runs the same feature table through
dsFlower across three Opal/Rock nodes.
