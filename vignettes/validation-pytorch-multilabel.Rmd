---
title: "Validation: pytorch_multilabel"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Validation: pytorch_multilabel}
...
```{r, fig.width=5.5, fig.height=3.2, fig.alt="Bar chart comparing centralized and federated validation loss for pytorch_multilabel."}
loss_df <- data.frame(
