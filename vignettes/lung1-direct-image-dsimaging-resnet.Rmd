...
technical path validation: the cohort is deliberately tiny, and the comparison
is not intended as a clinical imaging result.

The committed JSON is the raw `summary.json` emitted by the live May 2026
workflow.
