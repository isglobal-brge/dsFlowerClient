...
This vignette is a complete downstream radiomics-modeling notebook. It creates
or loads a radiomics feature table, trains a centralized baseline, then trains
the same feature set through dsFlower on three Opal/Rock nodes. Image
segmentation and radiomics extraction are upstream `dsImaging` steps; this page
shows the federated modeling stage on the derived features.
