---
title: "Validation: sklearn_svm"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Validation: sklearn_svm}
...
```{r, fig.width=5.5, fig.height=3.2, fig.alt="Bar chart comparing centralized and federated validation loss for sklearn_svm."}
loss_df <- data.frame(
