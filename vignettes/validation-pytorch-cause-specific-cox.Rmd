...
> `pytorch_cause_specific_cox` is not registered or exported in the current
> runtime. The non-executed commands below are historical evidence only.
...
This vignette records the catalogue coverage check for this formerly authorised
template. The historical run used three Opal/Rock nodes and the same pooled
