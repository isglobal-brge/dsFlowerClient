...
coverage run. They are evaluated when pkgdown renders the vignette, so the
page shows concrete centralized and federated outputs rather than only
...
same inline DataSHIELD/Flower flow shown below. The rendered result is
loaded from the committed evidence artifact written by that run.
