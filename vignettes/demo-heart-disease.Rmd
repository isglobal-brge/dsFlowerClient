...
This vignette is a complete clinical-tabular run notebook. It downloads the UCI
Cleveland Heart Disease table when available, trains a centralized baseline,
then uploads the same training rows to three Opal/Rock nodes and runs dsFlower.
