---
title: "Vision Validation: pytorch_unet2d"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Vision Validation: pytorch_unet2d}
...
> `pytorch_unet2d` and segmentation are not registered or exported in the
> current runtime. The non-executed commands below are historical evidence only.

```{r, include=FALSE}
knitr::opts_chunk$set(collapse = TRUE, comment = '#>')
method_id <- "pytorch_unet2d"
paths <- c(
...
```{r, fig.width=5.5, fig.height=3.2, fig.alt="Bar chart comparing centralized and federated validation loss for pytorch_unet2d."}
loss_df <- data.frame(
