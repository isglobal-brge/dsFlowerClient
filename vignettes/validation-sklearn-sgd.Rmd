---
title: "Validation: sklearn_sgd"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Validation: sklearn_sgd}
...
```{r, fig.width=5.5, fig.height=3.2, fig.alt="Bar chart comparing centralized and federated validation loss for sklearn_sgd."}
loss_df <- data.frame(
