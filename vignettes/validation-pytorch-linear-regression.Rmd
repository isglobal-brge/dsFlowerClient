---
title: "Validation: pytorch_linear_regression"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Validation: pytorch_linear_regression}
...
method_id <- "pytorch_linear_regression"
paths <- c(
...
```{r, fig.width=5.5, fig.height=3.2, fig.alt="Bar chart comparing centralized and federated validation loss for pytorch_linear_regression."}
loss_df <- data.frame(
