---
title: "Validation: sklearn_elastic_net"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Validation: sklearn_elastic_net}
...
```{r, fig.width=5.5, fig.height=3.2, fig.alt="Bar chart comparing centralized and federated validation loss for sklearn_elastic_net."}
loss_df <- data.frame(
