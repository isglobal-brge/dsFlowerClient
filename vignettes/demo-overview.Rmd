...
dsImaging, clinical privacy-profile benchmarks, and the template validation
suite that exercises every authorised method. Together they show the same
...
clinical_privacy <- data.frame(
  ...
  article = "clinical-privacy-benchmarks.html",
  data_path = c(
