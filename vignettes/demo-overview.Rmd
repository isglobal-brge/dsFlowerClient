...
coverage. The older self-contained public demos remain useful for installation
checks, but the presentation evidence is the recent clinical, imaging and
privacy-profile matrix.
