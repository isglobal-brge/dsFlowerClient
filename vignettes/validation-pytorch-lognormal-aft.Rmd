---
title: "Validation: pytorch_lognormal_aft"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Validation: pytorch_lognormal_aft}
...
> `pytorch_lognormal_aft` is not registered or exported in the current runtime.
> The non-executed commands below are preserved solely as historical evidence.

```{r, include=FALSE}
knitr::opts_chunk$set(collapse = TRUE, comment = '#>')
method_id <- "pytorch_lognormal_aft"
paths <- c(
...
```{r, fig.width=5.5, fig.height=3.2, fig.alt="Bar chart comparing centralized and federated validation loss for pytorch_lognormal_aft."}
loss_df <- data.frame(
