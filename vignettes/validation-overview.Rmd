...
catalogue coverage: they confirm that every authorised template can be staged,
executed, aggregated, persisted and cleaned up across three Opal/Rock servers.
