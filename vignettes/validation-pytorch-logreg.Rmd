---
title: "Validation: pytorch_logreg"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Validation: pytorch_logreg}
...
```{r, fig.width=5.5, fig.height=3.2, fig.alt="Bar chart comparing centralized and federated validation loss for pytorch_logreg."}
loss_df <- data.frame(
