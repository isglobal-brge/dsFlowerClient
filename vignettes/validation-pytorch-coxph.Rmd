---
title: "Validation: pytorch_coxph"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Validation: pytorch_coxph}
...
> `pytorch_coxph` is not registered or exported in the current runtime. The
> non-executed commands below are preserved solely as historical evidence.

```{r, include=FALSE}
knitr::opts_chunk$set(collapse = TRUE, comment = '#>')
method_id <- "pytorch_coxph"
paths <- c(
...
```{r, fig.width=5.5, fig.height=3.2, fig.alt="Bar chart comparing centralized and federated validation loss for pytorch_coxph."}
loss_df <- data.frame(
