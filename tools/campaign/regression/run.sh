...
for epsilon in 1 8 4; do
  Rscript tools/campaign/regression/run_cell.R "$ROOT" "$epsilon" inst/extdata/campaign/regression
done
"$ROOT/venvs/pytorch/bin/python" tools/campaign/regression/summarize.py inst/extdata/campaign/regression
