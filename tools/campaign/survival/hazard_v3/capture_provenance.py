...
value=dict(verified_utc=datetime.now(timezone.utc).isoformat(),package_source_matches_v050=True,
    ...
    harness_commit='6047074d99ece82884e4d91d0474e1877611a48e',
    tools_revision_note='Pod base HEAD retained from preprovisioned source; per-cell tool hashes and run-started hashes identify additive tooling.',
    ...
    preflight=dict(campaign_tests=5,survival_contract_tests=30,synthetic_federation='executed once, Adam + FedAvgM',
